    ...
    options: [
      {
        ...
        tags: ['社交', '高风险'],
        successRate: 0.4,
        successText: '你握紧口袋里的武器，推门下楼。路灯下的人影转过身来——一个满脸疲惫的中年人，衣服上有血迹，但眼神急切。「你是医生吗？我女儿发高烧，已经两天了。我在附近听说了你……」他说话的时候一直在发抖，不是害怕，是绝望。',
        failText: '你刚走到一楼，楼梯间就传来凌乱的脚步声——不止一个人。你立刻退回房间，锁死了门。外面的人等了几分钟，然后离开了。你始终没看清是谁。',
      },
      {
        id: 'talk_window',
        text: '隔着窗子交谈，保持安全距离',
        ...
        tags: ['社交', '谨慎'],
        successRate: 0.7,
        successText: '你推开窗户，但手始终没有离开武器。路灯下的人举着手后退了一步示意没有恶意。「前面三个街区有一群穿军装的人，武器装备很全。但他们不像正规军——我劝你绕路。」他顿了顿，「如果你有抗生素，我在河边仓库#7。我女儿需要药。」说完他转身消失在暗巷里。',
        failText: '你隔着窗子喊话，但对方似乎对你的警惕很失望。他摇了摇头，把什么东西塞进口袋，转身走了。你没能得到有价值的信息。',
      },
      {
        id: 'ignore_visitor',
        text: '不理会——半夜敲窗不是好兆头',
