    ...
    options: [
      {
        ...
        successRate: 0.9,
        onSuccess: {
          text: '你蹲下来，从背包里翻出医疗用品递给他。他接过绷带时手在微微颤抖——是失血还是紧张，你分不清。"谢了。我欠你一条命。"他低下头处理伤口，你注意到他登山包侧袋里插着一把带瞄准镜的手弩。',
          events: ['consume_random_medical'],
        },
        onFailure: {
          text: '你找遍了背包，但医疗用品已经用完了。你只能抱歉地摇摇头。他苦笑了一下：「没关系，我理解。」你继续赶路，心里有些不是滋味。',
        },
      },
      {
        id: 'trade_info',
    ...
    options: [
      {
        ...
        successRate: 0.4,
        onSuccess: {
          text: '你握紧口袋里的武器，推门下楼。路灯下的人影转过身来——一个满脸疲惫的中年人，衣服上有血迹，但眼神急切。「你是医生吗？我女儿发高烧，已经两天了。我在附近听说了你……」他说话的时候一直在发抖，不是害怕，是绝望。',
        },
        onFailure: {
          text: '你刚走到一楼，楼梯间就传来凌乱的脚步声——不止一个人。你立刻退回房间，锁死了门。外面的人等了几分钟，然后离开了。你始终没看清是谁。',
        },
      },
      {
        id: 'talk_window',
        ...
        successRate: 0.7,
        onSuccess: {
          text: '你推开窗户，但手始终没有离开武器。路灯下的人举着手后退了一步示意没有恶意。「前面三个街区有一群穿军装的人，武器装备很全。但他们不像正规军——我劝你绕路。」他顿了顿，「如果你有抗生素，我在河边7号仓库。我女儿需要药。」说完他转身消失在暗巷里。',
        },
        onFailure: {
          text: '你隔着窗子喊话，但对方似乎对你的警惕很失望。他摇了摇头，把什么东西塞进口袋，转身走了。你没能得到有价值的信息。',
        },
      },
      {
        id: 'ignore_visitor',
  ...
  wind_turbine: {
    ...
    options: [
      ...
      },
      {
        ...
        successRate: 0.9,
        onSuccess: {
          text: '你靠着风力发电机的混凝土底座坐下，背靠着嗡嗡作响的金属塔身。山风从你头顶吹过，视野开阔——如果有东西靠近，你很远就能看到。虽然不能完全放松，但至少在发电机规律的嗡鸣声中，你闭上眼睛休息了一会儿。醒來时精神状态好了很多。',
