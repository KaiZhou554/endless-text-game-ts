    ...
    options: [
      {
        ...
        successRate: 0.3,
        onSuccess: {
          text: '你用袖子捂住口鼻冲进浓烟。一楼已经烧穿了天花板，燃烧的木料像雨一样往下掉。你在二楼发现了这间公寓的前租户——蜷在墙角，双手还保持着遮挡面部的姿势，早已没有呼吸。他身边的登山包倒是完好，拉链被高温烤得烫手。你把包里的东西快速倒出来筛选：几包压缩饼干、一卷防水胶带、一把多功能钳。头顶传来楼板沉降的呻吟，你没有再翻第二个房间。从窗户翻出来时外套袖口还在冒烟。你蹲在街对面把火星拍灭，查看了从火场里带出来的东西。身上的灼伤要过一会才会开始疼。',
      ...
      },
      {
        ...
        successRate: 0.8,
        onSuccess: {
          text: '火焰吸引了丧尸的全部注意力。它们摇摇晃晃地朝火光聚拢，像飞蛾一样被光和热牵引。你绕到建筑背后，发现服务通道的入口没有丧尸把守。旁边的杂物间里有一箱被人遗漏的工具和几个罐头，大概是慌乱中没人顾得上搬走。你在货架底层还翻到了一卷没拆封的防水胶带和半盒电池。等第一只丧尸开始漫无目的地往你的方向折返时，你已经在几个街区之外了。',
