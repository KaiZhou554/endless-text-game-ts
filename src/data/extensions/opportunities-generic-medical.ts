...
export const opportunities_generic_medical: Opportunity[] = [
...

  {
    ...
    baseText: '路边的排水沟里躺着一个被丢弃的帆布背包，半边泡在泥水里。背包侧面有一个褪色的红十字标记。',
    type: 'dice',
    delay: 4,
    diceRanges: [
...

  {
    ...
    delay: 4,
    diceRanges: [
      { min: 1, max: 3, text: '密封袋里是一张照片和一张手写卡片。不是你该碰的东西。你失望地离开。', effects: { sanity: -5 } },
      { min: 4, max: 5, text: '密封袋里除了照片，还有几板崭新的止痛药。这里应该是某个幸存者的秘密藏匿点。', lootItem: 'painkillers' },
      { min: 6, max: 6, text: '密封袋里有全套急救用品，用橡皮筋扎得整整齐齐。惊喜收获。', lootItem: 'first_aid_kit' },
    ],
  },

  {
    ...
    diceRanges: [
      ...
      { min: 6, max: 6, text: '防水包里有几板完好的抗生素和一管没拆封的缝合线，还在有效期内。', lootItem: 'antibiotics' },
    ],
  },

  {
    ...
    delay: 4,
    diceRanges: [
      { min: 1, max: 2, text: '你挖开泥土打开箱子，里面是一窝刚出生的小老鼠。一无所获。', nothing: true },
...

  {
    ...
    baseText: '公园长椅上放着一个鼓鼓囊囊的塑料袋，看起来是来不及丢进垃圾桶的东西。',
    type: 'dice',
    delay: 4,
    diceRanges: [
      { min: 1, max: 3, text: '塑料袋里是几件旧T恤和一双破了洞的运动鞋。你翻了翻，还有半包过期的止咳糖。不是你想要的东西。', nothing: true },
      { min: 4, max: 5, text: '塑料袋里有几板没有标签的药片和一卷纱布。凭味道你判断是某种消炎药。', lootItem: 'painkillers' },
      { min: 6, max: 6, text: '塑料袋里有整盒的抗生素，算是意外之喜。', lootItem: 'antibiotics' },
    ],
  },

  {
    ...
    diceRanges: [
      ...
      { min: 6, max: 6, text: '纸箱的夹层里有一个被忽略的拉链包，里面装着完整的缝合套装——弯针、缝合线、持针器。', lootItem: 'suture_kit' },
    ],
  },

  {
    ...
    diceRanges: [
      ...
      { min: 6, max: 6, text: '急救包旁边竟然还有一小瓶没开封的止痛药和一支肾上腺素注射笔。售货机里为什么会有这些东西是个谜。', lootItem: 'adrenaline_shot' },
    ],
  },
