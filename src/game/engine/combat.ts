...
export function generateCombat(state) {
  const enemies = [
    ...
    { name: '自爆者', hp: 16, damage: 20, noise: 9, lootChance: 0.2, desc: '腹部肿胀发光，靠近即爆', traits: ['脆弱', '自爆'] },
    { name: '跑尸', hp: 15, damage: 8, noise: 0, lootChance: 0.3, desc: '速度极快', traits: ['快速'] },
    { name: '臃肿丧尸', hp: 35, damage: 10, noise: 2, lootChance: 0.5, desc: '皮糙肉厚', traits: ['庞大', '缓慢'] },
    { name: '变异丧尸', hp: 50, damage: 15, noise: 3, lootChance: 0.6, desc: '扭曲肢体', traits: ['庞大', '变异'] },
    { name: '邪教徒', hp: 25, damage: 7, noise: 2, lootChance: 0.5, desc: '疯狂活人', traits: ['人型', '狡猾'] },
    { name: '孢子丧尸', hp: 18, damage: 4, noise: 1, lootChance: 0.2, desc: '身体布满真菌，死后释放毒气', traits: ['集群', '毒气'] },
    { name: '潜行者', hp: 18, damage: 7, noise: 0, lootChance: 0.3, desc: '擅长从阴影中突袭', traits: ['隐蔽', '狡猾', '快速'] },
    { name: '巨臂丧尸', hp: 45, damage: 14, noise: 4, lootChance: 0.5, desc: '右臂肿胀成巨大棍棒', traits: ['庞大', '缓慢', '重击'] },
    { name: '丧尸乌鸦', hp: 8, damage: 3, noise: 3, lootChance: 0.1, desc: '成群的感染乌鸦，从空中俯冲', traits: ['快速', '飞行', '集群'] },
